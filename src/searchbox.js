        ...
        <div className={'col-span-12 md:col-span-7 bg-gray-900 border border-white rounded-3xl h-100 p-10'}>
            ...
            <div className={'grid grid-cols-12  text-white'}>
                <div className={'col-span-12 md:col-span-6 shadow-inner'}>
                    ...
                    <button onClick={searchStock} className={'px-4 bg-gray-400 hover:bg-gray-700 border-white-500 text-white rounded py-2 mr-5 text-white rounded'}>Search</button>
                </div>
